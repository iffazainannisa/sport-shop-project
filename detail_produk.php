...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php
        $query5 = " SELECT * FROM produk INNER JOIN sub_kategori ON produk.idsub_kategori=sub_kategori.idsub_kategori WHERE produk.idproduk=".$pid;
        // Execute the query
        ...
        if (!$result5){
          ...
          while ($row5 = $result5->fetch_object()){
            echo "<div class='col-xs-6 col-md-4'>";
              echo'<div class="w3-quarter" style="width:100%">';
            ...
            echo '<h1 style="text-transform:uppercase;"><b>'.$row5->nama_produk.'</b></h1>';
            echo'<p class="harga" style="background-color: pink;font-weight: bold; width:30%;">Rp'.$row5->harga.'</p>';
            ...
            echo "Deskripsi : ";
            echo "<div class='box box-info'>".$row5->deskripsi."</div>";
            echo "</div>";
          }
          echo "</div>";
        }
